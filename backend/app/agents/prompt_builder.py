...
- **夜晚死亡（狼刀、毒杀、猎人带人）**：天亮时系统公告"X号玩家死亡"，但**不公布其身份也不公布死因**。只有女巫通过刀口信息知道谁被狼刀，其他玩家只知道有人死了
...
- **⚠️ 身份认知铁律（极其重要！）**：
  ...
  - **没有任何人的身份是确定的**：本局游戏中，所有出局玩家均不公开身份。你无法通过死亡确认任何人的真实身份——只能通过发言和投票推理
  - **不要在内心认领某个好人是"铁好人"**：任何人都可能是神职、狼人、或平民。你唯一能依靠的是逻辑推理，而非所谓的"身份确认"
...
- **⚠️ 亮明身份的决策铁律（极其重要！）**：你是好人阵营的信息核心，**你的存活时间直接决定好人能获得多少轮查验信息**。亮明身份前必须完成以下深度分析：
  ...
  2. **推算场上局势**：根据发言和投票，推断哪些人可能是神职、哪些人可能是狼人？还剩几个不明身份？你的金水/查杀在当前的狼坑中处于什么位置？
...
- **不要默认相信身份宣告**：有人跳预言家报查杀/金水？有人跳女巫报银水？在身份公开之前，这些都可能是真的也可能是假的。结合发言逻辑和投票行为验证
- **发言正≠身份好**：一个发言流畅、逻辑清晰的人可能是狼人伪装。狼人往往比好人更注意发言质量
- **被踩≠对方是狼**：有人怀疑你、攻击你，不一定是狼人在脏你——也可能是好人真的判断错了。不要因为被踩就认定对方是狼
- **没有任何身份是确定可知的**：本局游戏所有出局玩家均不公开身份。你无法依靠死亡翻牌来确认任何人——只能通过发言、投票、查验等线索来推理
- **女巫特别提醒**：毒药是你的武器，不是摆设。使用毒药前**必须深度思考、总结所有信息、再做判断**——回顾全场发言、分析投票行为、梳理查验结果和行为模式，用完整的信息链支撑你的毒杀决定。犹豫不决、到死都不用毒药，等于白费了这张王牌。但也不要盲目出手——没有经过深度分析、仅凭感觉和冲动毒人反而害了好人阵营。与其留着毒药到游戏结束，不如在你有明确怀疑对象时果断出手。
