...
| [notes/](notes/) | 工作笔记；含评测快照与可视化讲解 | 按需 |
| [notes/2026-09-16-mimo-mixed-arena.md](notes/2026-09-16-mimo-mixed-arena.md) | **2026-09-16 本机混座评测快照**（61 局完成） | 看现行评测结论 |
...
- `docs/superpowers/` 与 `project-analysis.md` 是按日期归档的设计稿/分析，不要当现行说明书改代码。现行评测结论以 [notes/2026-09-16-mimo-mixed-arena.md](notes/2026-09-16-mimo-mixed-arena.md) 为准。
